...
class _AccountCreationPageState extends State<AccountCreationPage>
  ...
  Uint8List _createExcelTemplate(String type) {
    ...
    late List<List<dynamic>> sampleData;
  ...
  String _createCsvTemplate(String type) {
    late List<String> headers;
    late List<List<String>> sampleData;
  ...
  Widget _buildSampleDataPreview(String type, bool isMobile) {
    ...
    if (type == 'Students') {
      ...
      sampleRows = [
        ['2203A51291', 'John Doe', 'CSE', '22CSBTB09', '2'],
        ['2203A51292', 'Jane Smith', 'CSE', '22CSBTB09', '2'],
      ];
    } else if (type == 'Faculty') {
      headers = ['facultyId', 'facultyName', 'department', 'designation'];
      sampleRows = [
        ['FAC001', 'Dr. Jane Doe', 'CSE', 'Asst. Prof'],
        ['FAC002', 'Dr. John Smith', 'CSE', 'Assoc. Prof'],
      ];
    } else {
      headers = ['feePaymentId', 'staffName', 'department'];
      sampleRows = [
        ['FEE001', 'Finance Officer 1', 'Accounts'],
        ['FEE002', 'Finance Officer 2', 'Accounts'],
      ];
    }
