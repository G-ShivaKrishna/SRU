        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Column(
                children: [
                  _buildSectionCard('Student Basic Information', [
                    _buildInfoRow('Registration Number', '2203A51291'),
                    _buildInfoRow('Student Name', 'GOTTIMUKKULA SHIVA KRISHNA REDDY'),
                    _buildInfoRow('Father\'s Name or Guardian', 'GOTTIMUKKULA SRINIVAS REDDY'),
                  ...
                  _buildSectionCard('Student Admission Information', [
                  ...
                  const SizedBox(height: 16),
                  _buildSectionCard('Academic Details', [
                    _buildInfoRow('SSC School Name', 'Sri Saraswathi'),
                    _buildInfoRow('Board of SSC', 'SSC'),
                    _buildInfoRow('SSC Percentage', '9.2'),
                    _buildInfoRow('Intermediate College', 'Sri Saraswathi Junior College'),
                    _buildInfoRow('Board of Intermediate', 'JUNIOR COLLEGE'),
                    _buildInfoRow('Intermediate Percentage', '9.4'),
                  ], context),
                  const SizedBox(height: 16),
                  _buildSectionCard('CET Details', [
                  ...
                  const SizedBox(height: 16),
                  _buildSectionCard('Permanent Address', [
                    _buildInfoRow('Address Line 1', 'H.NO.6-3-RAMA KRISHNA NAGAR'),
                    _buildInfoRow('Address Line 2', 'JANGAON'),
                    _buildInfoRow('City', 'JANGAON'),
                    _buildInfoRow('State', 'TELANGANA'),
                  ...
                  const SizedBox(height: 16),
                  _buildSectionCard('Aadhar Card Details', [
                    _buildInfoRow('Aadhar Number', '****1234'),
                    _buildInfoRow('Address', 'H.NO.6-3-RAMA KRISHNA NAGAR\nJANGAON\nJANGAON\nTELANGANA\n506167'),
