...
class FacultyAcademicsScreen extends StatefulWidget {
  const FacultyAcademicsScreen({super.key});

  @override
  State<FacultyAcademicsScreen> createState() => _FacultyAcademicsScreenState();
}

class _FacultyAcademicsScreenState extends State<FacultyAcademicsScreen> {
  String? selectedYear;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Teaching Schedule & Academic Calendar'),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 12),
            Text(
              'to view the teaching schedule and academic calendar',
              style: TextStyle(
