...
class _UpdateBasicDataScreenState extends State<UpdateBasicDataScreen> {
  ...
  void _populate(Map<String, dynamic> d, String authEmail) {
    ...
    _religion =
        _valid(d['religion'], ['Hindu', 'Muslim', 'Christian', 'Other']);
    _caste = _valid(d['caste'], ['BC-A', 'BC-B', 'SC', 'ST', 'OC']);
    _casteNameCtrl.text = d['casteName'] ?? '';
    _bloodGroup = _valid(d['bloodGroup'],
                            ...
                            child: ConstrainedBox(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  _sectionHeader('Employee Basic Information',
                                  ...
                                  _sectionBody(isMobile, [
                                    _dropdownField(
                                        ...
                                        (v) => setState(() => _title = v)),
                                    _readOnlyField(
                                        'Employee Name', _readOnlyName),
                                    _readOnlyField(
                                        'Designation', _readOnlyDesignation),
                                    _readOnlyField('Department', _readOnlyDept),
                                    _readOnlyField(
                                        'Employee ID', _readOnlyEmpId),
                                    _dateField(
                                        'Date of Joining', _dateOfJoiningCtrl),
                                    _dropdownField(
                                        'Appointment Type',
                                        ['Regular', 'Contract'],
                                        _appointmentType,
                                    ...
                                    _textField('Favourite Courses',
                                        _favoriteCoursesCtrl),
                                    _textField('Google Scholar Link',
                                        _googleScholarCtrl),
                                    _textField('LinkedIn Link', _linkedInCtrl),
                                    _textField(
                                        'Instagram Link', _instagramCtrl),
                                    _textField('Facebook Link', _facebookCtrl),
                                    _textField('Scopus ID', _scopusCtrl),
                                    _textField(
                                        'Personal Website', _websiteCtrl),
                                    _textField('YouTube Link', _youtubeCtrl),
                                    _textField(
                                        'Twitter / X Link', _twitterCtrl),
                                  ]),
                                  const SizedBox(height: 16),
                                  _sectionHeader('Personal Details *',
                                      const Color(0xFFF2B233)),
                                  _sectionBody(isMobile, [
                                    _textField("Father's Name", _fatherNameCtrl,
                                        required: true),
                                    _textField("Mother's Name", _motherNameCtrl,
                                        required: true),
                                    _textField(
                                        'Identification Mark 1', _idMark1Ctrl,
                                        required: true),
                                    _textField(
                                        'Identification Mark 2', _idMark2Ctrl),
                                    _dropdownField(
                                        'Gender *',
                                        ['M', 'F', 'Other'],
                                        _gender,
                                    ...
                                    _dropdownField(
                                        ...
                                        required: true),
                                    _textField(
                                        'Name of the Caste *', _casteNameCtrl,
                                        required: true),
                                    _dropdownField(
                                        'Blood Group *',
                                        [
                                  ...
                                  const SizedBox(height: 16),
                                  _sectionHeader('ID Proof Details *',
                                      const Color(0xFF1E88E5)),
                                  _sectionBody(isMobile, [
                                    _textField('PAN Number *', _panCtrl,
                                        required: true),
                                    _textField(
                                        'Aadhar Card Number *', _aadharCtrl,
                                        required: true),
                                  ...
                                  const SizedBox(height: 16),
                                  _sectionHeader('Contact Address Details *',
                                  ...
                                  _sectionBody(isMobile, [
                                    _dropdownField(
                                        ...
                                        _states,
                                        _conState,
                                        (v) => setState(() => _conState = v),
                                        required: true),
                                    _dropdownField(
                                        'District *',
                                        _districts,
                                        _conDistrict,
                                        (v) => setState(() => _conDistrict = v),
                                        required: true),
                                    _dropdownField(
                                        'Mandal *',
                                        _mandals,
                                        _conMandal,
                                        (v) => setState(() => _conMandal = v),
                                        required: true),
                                    _dropdownField(
                                        'Village *',
                                        _villages,
                                        _conVillage,
                                        (v) => setState(() => _conVillage = v),
                                        required: true),
                                    _textField('Street *', _conStreetCtrl,
                                        required: true),
                                    _textField('House No. *', _conHouseCtrl,
                                        required: true),
                                    _textField('Pin Code *', _conPinCtrl,
                                        required: true,
                                        keyboardType: TextInputType.number),
                                    _textField('Personal Email ID *',
                                        _personalEmailCtrl,
                                        required: true,
                                        keyboardType:
                                            TextInputType.emailAddress),
                                    _textField('Mobile No. 1 *', _mobile1Ctrl,
                                        required: true,
                                        keyboardType: TextInputType.phone),
                                    _readOnlyField('College Email ID',
                                        _readOnlyCollegeEmail),
                                    _textField('Mobile No. 2', _mobile2Ctrl,
                                        keyboardType: TextInputType.phone),
                                  ]),
                                  CheckboxListTile(
                                    ...
                                    onChanged: (v) {
                                      setState(
                                          () => _sameAsContact = v ?? false);
                                      if (_sameAsContact) _copySameAsContact();
                                    },
                                    title: const Text(
                                        'Select if Contact Address & Permanent Address are the same'),
                                    controlAffinity:
                                        ListTileControlAffinity.leading,
                                    contentPadding: EdgeInsets.zero,
                                  ),
                                  const SizedBox(height: 4),
                                  _sectionHeader('Permanent Address Details *',
                                  ...
                                  _sectionBody(isMobile, [
                                    _dropdownField(
                                        ...
                                        _states,
                                        _perState,
                                        (v) => setState(() => _perState = v),
                                        required: !_sameAsContact),
                                    _dropdownField(
                                        'District *',
                                        _districts,
                                        _perDistrict,
                                        (v) => setState(() => _perDistrict = v),
                                        required: !_sameAsContact),
                                    _dropdownField(
                                        'Mandal *',
                                        _mandals,
                                        _perMandal,
                                        (v) => setState(() => _perMandal = v),
                                        required: !_sameAsContact),
                                    _dropdownField(
                                        'Village *',
                                        _villages,
                                        _perVillage,
                                        (v) => setState(() => _perVillage = v),
                                        required: !_sameAsContact),
                                    _textField('Street *', _perStreetCtrl,
                                        required: !_sameAsContact),
                                    _textField('House No. *', _perHouseCtrl,
                                        required: !_sameAsContact),
                                    _textField('Pin Code *', _perPinCtrl,
                                        required: !_sameAsContact,
                                        keyboardType: TextInputType.number),
                                    _textField('Emergency Contact No. 1 *',
                                        _emergency1Ctrl,
                                        required: true,
                                        keyboardType: TextInputType.phone),
                                    _textField('Emergency Contact No. 2',
                                        _emergency2Ctrl,
                                        keyboardType: TextInputType.phone),
                                  ]),
  ...
  Widget _sectionBody(bool isMobile, List<Widget> fields) {
    return Container(
      ...
      child: Wrap(
        ...
        children: fields
            .map((f) =>
                SizedBox(width: isMobile ? double.infinity : 360, child: f))
            .toList(),
      ),
    );
  }
  ...
  Widget _dateField(String label, TextEditingController ctrl,
    ...
    return TextFormField(
      ...
      onTap: () async {
        DateTime? init;
        try {
          init = ctrl.text.isNotEmpty ? DateTime.parse(ctrl.text) : null;
        } catch (_) {}
