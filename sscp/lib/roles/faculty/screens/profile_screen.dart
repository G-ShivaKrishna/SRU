                ...
                child: ConstrainedBox(
                  ...
                  child: Column(
                    children: [
                      ...
                      _card(
                          'Online Profiles & Links', const Color(0xFF1976D2), [
                        _row2('Google Scholar', _v('googleScholarLink'),
                            'LinkedIn', _v('linkedInLink')),
                        _row2('Scopus ID', _v('scopusId'), 'Personal Website',
                            _v('personalWebsite')),
                        _row2('Instagram', _v('instagramLink'), 'Facebook',
                            _v('facebookLink')),
                        _row2('YouTube', _v('youtubeLink'), 'Twitter / X',
                            _v('twitterLink')),
                      ]),
                      const SizedBox(height: 12),

                      _card('Personal Details', const Color(0xFFF2B233), [
                        _row2("Father's Name", _v('fatherName'),
                            "Mother's Name", _v('motherName')),
                        _row2('Date of Birth', _v('dateOfBirth'), 'Gender',
                            _v('gender')),
                        _row2('Blood Group', _v('bloodGroup'), 'Marital Status',
                            _v('maritalStatus')),
                        _row2('Religion', _v('religion'), 'Caste', _v('caste')),
                        _row2('Caste Name', _v('casteName'),
                            'Differently Abled', _v('differentlyAbled')),
                        _row2(
                            'Identification Mark 1',
                            _v('identificationMark1'),
                            'Identification Mark 2',
                            _v('identificationMark2')),
                      ]),
                      const SizedBox(height: 12),

                      _card('ID Proof Details', const Color(0xFF1E88E5), [
                        _row2('PAN Number', _v('panNumber'), 'Aadhar Number',
                            _v('aadharNumber')),
                        _row2('Voter ID', _v('voterId'), 'Passport No',
                            _v('passportNo')),
                      ...
                      _card('Contact Address', const Color(0xFFE53935), [
                        _row2('State', _v('contactState'), 'District',
                            _v('contactDistrict')),
                        _row2('Mandal', _v('contactMandal'), 'Village',
                            _v('contactVillage')),
                        _row2('Street', _v('contactStreet'), 'House No.',
                            _v('contactHouseNo')),
                        _row2('Pin Code', _v('contactPinCode'),
                            'Personal Email', _v('personalEmail')),
                        _row2('Mobile No. 1', _v('mobileNo1'), 'Mobile No. 2',
                            _v('mobileNo2')),
                      ...
                      _card('Permanent Address', const Color(0xFF1AA6B8), [
                        if (_data?['sameAsContact'] == true)
                          ...
                          _row2('State', _v('permanentState'), 'District',
                              _v('permanentDistrict')),
                          _row2('Mandal', _v('permanentMandal'), 'Village',
                              _v('permanentVillage')),
                          _row2('Street', _v('permanentStreet'), 'House No.',
                              _v('permanentHouseNo')),
                          _row2('Pin Code', _v('permanentPinCode'), '', ''),
                        ],
                        _row2('Emergency Contact 1', _v('emergencyContact1'),
                            'Emergency Contact 2', _v('emergencyContact2')),
                      ]),
